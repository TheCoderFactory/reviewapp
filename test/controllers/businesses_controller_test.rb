...
class BusinessesControllerTest < ActionController::TestCase
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post :create, business: { name: @business.name, phone: @business.phone, user_id: @business.user_id, website: @business.website }
    end
  ...
  test "should update business" do
    patch :update, id: @business, business: { name: @business.name, phone: @business.phone, user_id: @business.user_id, website: @business.website }
    assert_redirected_to business_path(assigns(:business))
  end
